package com.ut.sm41.service.enums;
...
public enum RoleEnum {
    ...
    public static RoleEnum roleFromShort(Short input){
        ...
        switch (input){
            ...
            case 1: ouput = RoleEnum.EMPLOYE;
                break;

            case 2: ouput = RoleEnum.FACILITY;
                break;

            case 3: ouput = RoleEnum.ADMIN;
                break;

            case 4: ouput = RoleEnum.USER;
                break;

            case 5: ouput = RoleEnum.MANAGER;
                break;
